...
const ProfileScreen = () => {
  ...
  return (
    <View style={styles.container}>
      source={require("../assets/Microphen.jpg")} // Adjust the path to your
        ...
        {userDetails ? (
          <>
            <Text style={styles.welcomeText}>
              Welcome to the Seamless Voice Recording App!
            </Text>
            <Text style={styles.infoText}>Welcome: {userDetails.email}</Text>
            <TouchableOpacity
              style={styles.button}
